...
<body>
	<div class="container-fluid display-table">
		<div class="row display-table-row">
            ...
            <a href="add_fac.php"><button class="btn btn-success">Add Faculty</button></a>
            <br>
            <br>
            <form action = "search_fac.php" method="POST">
        ...
        <thead>
                    ...
                    <th style='text-align: center;'> FACULTY DEGREE</th>
                    
                    <th style='text-align: center;'> ACTION</th>
        </thead>
        <?php
        $con = mysqli_connect('localhost','root','','capstone2');
        $qry = mysqli_query($con, "SELECT * FROM faculty")or die(mysqli_error($con));
        ...
        if ($num_row > 0){
            while($row = mysqli_fetch_array($qry)){
                ...
                echo "<td>".$row[1]."</td>";
                echo "<td>".$row[2]."</td>";
                echo "<td>"."<a href='edit_fac.php?fac_id=$row[0]'><button style='margin-left:5px' class='btn btn-sm btn-info'>Edit</button></a> <a href='delete_fac.php?fac_id=$row[0]'><button class='btn btn-sm btn-danger'>Delete</button></a>"."</td>";
                echo "</tr>";
				echo "</tbody>";
        }
    }
