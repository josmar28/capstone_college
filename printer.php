	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			...
			<div class="col-md-10 display-table-cell valign-top box">
                ...
                <a href="printprinter.php">  <button class="btn btn-success">Print</button></a>
                <a href="open.php"><button  class="btn btn-default">Back</button></a>
                <div class="row">
						<div class="col-md-12">
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Open Laboratory Printer Usage"
	},
	subtitles: [{
