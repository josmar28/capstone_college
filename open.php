...
$dataPoints = array(
	array("label"=>"BSIT", "y"=>$bsit2),
    array("label"=>"BSCS", "y"=>$bscs2),
    array("label"=>"BSIS", "y"=>$bsis2),
    array("label"=>"MMA", "y"=>$mma2),
    array("label"=>"MMA", "y"=>$blis2),
)
	...
	<div class="container-fluid display-table">
		...
		<div class="col-md-2 display-table-cell valign-top" id="side-menu">
			...
			<div class="col-md-10 display-table-cell valign-top box">
                ...
                <a href="printopen.php"> <button class="btn btn-success">Print</button></a>
                <a href="printer.php"><button class="btn btn-info">Next Chart</button></a>
                <a href="stat.php"><button  class="btn btn-default">Back</button></a>
                <div class="row">
						<div class="col-md-12">
