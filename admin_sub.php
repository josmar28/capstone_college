...
<body>
	<div class="container-fluid display-table">
        ...
        <div>
        <a href="add_sub.php"><button class="btn btn-success" style="margin-top:10px;">Add Subject</button></a>
        <br>
            <br>
        ...
        $qry = mysqli_query($con, "SELECT  subject.sub_id AS id,
							subject.sub_code AS code,
								...
								subject.day AS day,
								faculty.fac_name
								FROM subject INNER JOIN faculty ON subject.fac_id = faculty.fac_id")or die(mysqli_error($con));
