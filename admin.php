...
<body>
	<div class="container-fluid display-table">
		<div class="row display-table-row">
            ...
            <br>
            <br>
            <form action = "mem_search.php" method="POST">
        ...
        $qry = mysqli_query($con, "SELECT student.stud_id as stud_id,
						...
						FROM user INNER JOIN student ON student.user_id = user.user_id
								  INNER JOIN semester ON student.sem_id = semester.sem_id")or die(mysqli_error($con));
        ...
        if ($num_row > 0){
            while($row = mysqli_fetch_array($qry)){
                ...
                echo "<td>"."<a href='edit.php?stud_id=$row[0]'><button style='margin-left:5px' class='btn btn-sm btn-info'>Edit</button></a> <a href='delete.php?user_id=$row[3]'><button class='btn btn-sm btn-danger'>Delete</button></a>"."</td>";
                echo "</tr>";
				echo "</tbody>";
        }
    }
